                    ...
                    <tr>
                        ...
                        <td>
                            <form action="" class="POST">
                                ...
                                <a href="?page=jabatandelete&id=<?php echo $row['id']?>" class="btn btn-danger btn-sm javascript: return confirm('Konfirmasi data akan dihapus?')"><i class="fa fa-trash"></i> Hapus</a>
                            </form>
                        </td>
                    </tr>
                <?php
